//
//  SelectSoundForTabBarItemVC.swift
...
import AVFoundation
import FBSDKCoreKit
class SelectSoundForTabBarItemVC: UIViewController ,AVAudioPlayerDelegate{
...
//    var soundsCategories = ["Motivation","Faith","Self Help","Fitness", "Social", "Business", "Philosophy", "Spirituality" ]
    ...
    override func viewDidLoad() {
        ...
        segueInfo = SegueInfo(curCellIndex: alarmModel.count, isEditMode: false, label: "Alarm", mediaLabel: defaultSound.soundName, mediaID: "", repeatWeekdays: [], enabled: false, snoozeEnabled: false, imageName: defaultSound.image, category: defaultSound.category, repeatEnabled: false)
...
extension SelectSoundForTabBarItemVC:UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
